package userstoreproducer.service;

import static userstoreproducer.queries.DBqueries.*;
...
import userstoreproducer.queries.DBqueries;
...
//	}
	...
	public ResultSet getUserByNicAndRole(String nic, String role) {
		try {
			preparedStatement = connection.prepareStatement(GET_USERS_BY_NIC_AND_ROLE);
			preparedStatement.setString(1, nic);
